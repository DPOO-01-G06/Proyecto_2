...
public class StartFrame extends JFrame{
	...
	private ClickManager clickManager = new ClickManager(this);
	...
	public void setUser() throws FileNotFoundException{
		...
		if (accessPanel instanceof SignUpPanel) {
			user = new User(accessPanel.getUsername(), accessPanel.getPassword());
		} else {
			user = User.signIn(accessPanel.getUsername(), accessPanel.getPassword());
		}
	}
